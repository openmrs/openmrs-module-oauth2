...
<ul id="menu">
    ...
    <li class="active"
        <c:if test='<%= request.getRequestURI().contains("module/oauth2/runSmartApps/runSmart.form") %>'>class="active"</c:if>>
        <a
                href="${pageContext.request.contextPath}/module/oauth2/runSmartApps/runSmart.form"><spring:message
                code="oauth2.run.smart"/></a>
    </li>
