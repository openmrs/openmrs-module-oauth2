...
import org.openmrs.module.oauth2.api.smart.db.SmartDAO;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Repository;

/**
 * It is a default implementation of  {@link SmartDAO}.
 */
@Repository
public class HibernateSmartDAO<T> implements SmartDAO<T> {
	 ...
	 * @param mappedClass
	 */
	protected HibernateSmartDAO(Class<T> mappedClass) {
